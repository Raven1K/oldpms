 ...
 <!--                    <a href="index.php" class="logo pull-left"><img src="images/oldpmslogin.png" class="mb-2" height="50" alt="OLDPMS" /></a> -->
                ...
                <form action="processphp/prclogin.php" class="form-horizontal" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" data-val="true"  id="User" name="user" type="text" value="" />
                        ...
                        <hr />
                            ...
                            <button type="button" onclick="window.location.href='Register2.php'" class="mb-xs mt-xs mr-xs btn btn-warning">Register</button>
                        </form>
                        </div>
