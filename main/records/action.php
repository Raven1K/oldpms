								...
								<table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                         <tr>
											...
											<td>
												...
												<a href="evaluation.php" class="btn btn-round btn-primary btn-sm ">                                        			
                                        			<span class="text align-content-center"><strong>Release</strong></span>
                                            ...
                                            <td>
												<span class="text-primary"><i class="bi bi-upload me-1 text-primary"></i><strong>For Client</strong></span>
                                         ...
                                         <tr>
                                            ...
                                            <td >
												<span class="text-success"><i class="bi bi-upload me-1 text-info"></i><strong> Released </strong></span>
											</td>                               
                                         </tr>
                                         <tr>
											<td>5</td>
