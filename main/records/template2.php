    ...
    <style>
	   ...
	   <style>
		#example1 {
		  ...
		  background: url("acknowledge.png");
    ...
    <table style="margin: 0 auto;">
        <tr>
            <td class="title" style="width:15%; text-align: center;">
                <img src="seal.png" style="width: 100%; max-width: 150px" />
            </td>
            ...
            <td class="title" style="width:15%; text-align: center;">
                <img src="bagongpilipinas.png" style="width: 100%; max-width: 180px" />
            </td>
        </tr>
    </table>
</div>
...
<div id="example2">
   ...
   <dt class="col-sm-3">Very truly yours.</dt>
    <br/>
	<p align="left"><strong>MARITESS M. OCAMPO</strong></br>
		OIC, Regional Executive Director</br>
		<img src="img/RED_OCAMPO.png" style="width: 150px; height: auto; margin-top: -92px;">
	</p>
...
<div class="broken-line"></div>
	...
	<p align="right"><u><strong>{{owner}}</strong></u> <br>
		Permittee </p></br><br><br><br><br><br>
	
	<dt class="col-sm-3" style="text-align:justify;">The permittee hereby acknowledges having read, understood and hereby agrees to bind himself/herself to this terms and conditions governing the lumber dealer permit from DENR Caraga.</dt>
	</br>
	<p align="right">On this  <u><strong>{{dateclient}}</strong></u> , 
		 </p>	
	<p align="right">Digitally signed by <u><strong>{{owner}}</strong></u> by clicking the acknowledge button  </br><br><br><br><br><br>
		 </p>
