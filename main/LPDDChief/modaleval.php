      ...
      <div class="row">
	   ...
	   <div class="col-md-3 ms-auto">
		   <h2><strong>Remarks *</strong></h2>
  		     <textarea maxlength="5000" data-msg-required="Please type your remarks." rows="15" class="form-control" name="message" id="message" placeholder="Please type your comments if returned." required></textarea>
	   </div>											      
   </div>
</div>
</div>
