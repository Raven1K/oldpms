								...
								<table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                         <tr>
                                            ...
                                            <td>
												<span class="text-primary"><i class="bi bi-upload me-1 text-primary"></i><strong>For Initial</strong></span>
                                         ...
                                         <tr>
                                            ...
                                            <td >
												<span class="text-success"><i class="bi bi-upload me-1 text-info"></i><strong> For Signature</strong></span>
											</td>                               
                                         </tr>
                                         <tr>
											<td>5</td>
