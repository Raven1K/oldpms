...
$Time = date("h:i:sa");
   ...
   $Title = 'Chief, LPDD';
   $Details = 'Documents reviewed and recommend to ARD TS the approval of the endorsement for the RED to approve the E-Permit.';
...
// ------------------------------------------------------------------------------------------------
            ...
            echo "<script type='text/javascript'>alert('Successfully Endorsed');location='action.php';</script>";
          }
            
          // Function call
          function_alert("Successfully Endorsed!");
...
<form method="post" >
                <li> <button  type="submit" name="endorse" class="btn-primary btn-sm btn-round btn ml-0" >                                       				 
									   <span class="text align-content-center text-white"><strong>Endorse</strong></span>
          ...
          
          {
              ...
              //     echo(htmlentities ('To Endorse') );
              //     echo("</td><td>");
              //   echo('<a class="btn btn-warning"  target="_blank" href="generate_VIEW.php?lumber_app_id='.$row['lumber_app_id'].'">View</a>');
            ...
            elseif (($row['doc_type_name']) == ('For Initial Generated RED Endorsement')){
              echo(htmlentities ('To Endorse') );
              echo("</td><td>");
            echo('<a class="btn btn-warning"  href="generate_VIEW.php?lumber_app_id='.$row['lumber_app_id'].'">View</a>');
          }

          
          elseif (($row['doc_type_name']) == ('Lumber Dealer E-Permit')){
            echo(htmlentities ('To Endorse') );
            echo("</td><td>");
          // echo('<a class="btn btn-warning"  href="GenerateCert.php?lumber_app_id='.$row['lumber_app_id'].'">View</a>');
          echo('<a class="btn btn-warning" target="_blank" href="generate_viewLumberEdealer.php?lumber_app_id='.$row['lumber_app_id'].'">View</a>');
        }
