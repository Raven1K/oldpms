...
// $value = '<a class="cid value="ADSADASD">sdfsdfsdfsdfdsfsdfs</a>';
// echo $value ;
error_reporting(0);
...
if (isset($_POST['submit'])) {
	...
	$registration_id = $_POST['result'];

	$lumber_app = "SELECT * FROM lumber_application where Registration_Number = $registration_id";
	$lumber_app_qry = mysqli_query($con, $lumber_app);
	$lumber_ap_row = mysqli_fetch_assoc($lumber_app_qry);
	$registration_number = $lumber_ap_row['lumber_app_id'];


	echo $registration_id;
	
	// records/generate_viewLumberEdealer.php?lumber_app_id=425
}
