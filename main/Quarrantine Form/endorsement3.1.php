					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">											
								...
								<div class="x_content">
									<br />
									<form class="form-label-left input_mask" method="post" action="generate_POST.php" formtarget="_blank" target="_blank">
									...
									<div class="item form-group row">
												...
												<div class="col-md-4 col-sm-4 ">
													<input type="text" class="form-control" placeholder="Reference Number" name="refnumber" id="refnumber" value="<?php echo 'LD-R13-'.''.$lumber_ap_row['Suffix'].'-'.$dateyear.'00'.$lumber_ap_row['lumber_app_id']; ?>">
												</div>
											</div>
											...
											<div class="item form-group row">
												...
												<div class="col-md-4 col-sm-4 ">
													<input type="text" class="form-control" placeholder="Reference Number" name="refnumber" id="refnumber" value="<?php echo $lumber_ap_row_payment['Reference_Number']; ?>">
												</div>
											</div>
											...
											<div class="item form-group row">
												...
												<div class="col-md-4 col-sm-4 ">
													<input type="text" class="form-control" placeholder="Lumber Dealer" name="ldname" id="ldname" value="<?php echo $lumber_ap_row['bussiness_name']; ?>">
												</div>
											</div>
											<div class="item form-group row">
											 <label class="col-form-label col-md-2 col-sm-2 label-align">Lumber Dealer Address</label>
												<div class="col-md-4 col-sm-4 ">
													<input type="text" class="form-control" placeholder="Address" name="ldaddress" id="ldaddress" value="<?php echo $lumber_ap_row['full_address']; ?>">
												</div>
											</div>
											<div class="item form-group">
											...
											<span class="section"><strong>Department of Trade and Industry (DTI) Details</strong></span>
											<div class="item form-group row">
