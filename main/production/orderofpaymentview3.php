<?php
              ...
              $office_cover = $result2['office_cover'];
                ...
                $query = "SELECT * FROM denr_users WHERE Office_id = ? and user_role_id = 9 ";
...
if ($stmt) {
  ...
  <div class="container mt-5 border border-dark border-3 p-3 w-50">
    <div class="container mt-1">
            ...
            echo '<a href="application.php" class="btn btn-primary" id="OpenDocument" hidden>Cancel</a>';
            echo ' ';
      ...
      <div class="row">
        ...
        <div class="d-flex justify-content-center align-items-end col-6 mt-2">
          <img src="<?php echo $signature; ?>" alt="Signature Image" style="max-width: 200px; max-height: 100px;">
        </div>
        <div class="text-end col-11 mt-3" ><u><b>____________<?php echo $official_name;?>_______________</b></u></div>
