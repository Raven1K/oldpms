...
if (empty($lumber_app_id) || empty($bname) || empty($Saddress) || empty($ownername) || empty($ptadd) || empty($exdate) || empty($office_cover) || empty($validity_val) || empty($other)) {
  // If any variable is empty, display an alert message
...
// if ($count > 0) {
//     echo "Error: lumber_app_id already exists in the database.";
// } else {
...
<div class="col-md-12 col-sm-12  form-group has-feedback">
  <input type="text" class="form-control has-feedback-left"  placeholder="# Year of Validity" name="validity_val" id="ptadd" required>
  <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
</div>
<!--
<div class="col-md-6 col-sm-6  form-group has-feedback">
...
<div class="col-md-12 col-sm-12  form-group has-feedback">
<h6 class="modal-title text-warning"><strong>Wood Species:</strong></h6>
  <div class="form-group row">
  <label class="col-form-label col-md-3 col-sm-2 label-align" >Falcata</label>
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control"  placeholder="bd.ft." name="falcu" id="falcu" />
  </div>
  <label class="col-form-label col-md-3 col-sm-2 label-align ">Mahogany</label>
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control input"  placeholder="bd.ft." name="macu" id="macu" />
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control input"  placeholder="bd.ft." name="gecu" id="gecu" />
  </div>
  <label class="col-form-label col-md-3 col-sm-2 label-align">Caimito</label>
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control input"  placeholder="bd.ft." name="cacu" id="cacu" />
  </div>
 ...
 <div class="form-group row">
  ...
  <div class="col-md-3 col-sm-3 ">
  <input type="text" class="form-control input"  placeholder="bd.ft." name="mancu" id="mancu" />
  </div>

  <label class="col-form-label col-md-3 col-sm-2 label-align">Mangium</label>
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control input"  placeholder="bd.ft." name="mang" id="mang" />
  </div>
...
<div class="form-group row">
  <label class="col-form-label col-md-3 col-sm-2 label-align">Others</label>
  <div class="col-md-6 col-sm-6 ">
    <input type="text" class="form-control input"  placeholder="Name of Specie" name="other" id="other" />
  </div>
  <div class="col-md-3 col-sm-3 ">
    <input type="text" class="form-control input"  placeholder="bd.ft." name="others" id="others" />
  </div>
</div>
<div class="form-group row">
	  ...
	  <div class="row">
		  <div class="col-sm-12">
		   ...
		   <!-- <h2 class="text-warning"><strong>"Department of Trade and Industry (DTI) Details"</strong></h2> -->
			  								...
			  								<div class="item form-group row">4
												<!-- <label class="col-form-label col-md-4 col-sm-4 label-align">Issued Date</label> -->
												<div class="col-md-5 col-sm-5 ">
