...
<?php include 'return.php'; ?>
          ...
          
          {
              ...
              $Approved_CG = 'Approved (CG)';
                ...
                echo(htmlentities ('Reviewed') );
                echo("</td><td>");
                echo ('<a class="btn btn-warning" target="_blank" href="generates_view_pdf2.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
 ...
 $Time = date("h:i:sa");
    ...
    $Title = 'PENRO Chief, RPS';
    $Details = 'Documents reviewed. Application endorsed to the Chief, TSD.';
 ...
 // ------------------------------------------------------------------------------------------------
  ...
  function function_alert($message) {
	...
	echo "<script type='text/javascript'>alert('Successfully Endorsed');location='application.php';</script>";
}
...
<form method="POST">
    <input class="btn btn-success" type="submit" value="Endorse to Chief TSD" name="Approve_All">
</form>
