...
<td style="width:85%;">
    ...
    <br/>
    <!-- <br/>
	<dd class="col-sm-9">Prepared by:</dd>
    <br/>
    <br/>
    <dd class="col-sm-9"><strong>ANITA E. TEJERO</strong></dd> 
    <br/>
    <br/>
    <br/>
    <dd class="col-sm-9">Verified by:</dd>
    <br/>
    <br/>
    <dd class="col-sm-9"><strong>MARITES C. ORCULLO</strong></dd> 
    <br/>
    <br/> -->

      <!-- <img src="uploads/c_certificate1.png"  class="align padding-right"style="width: 600%; max-width: 600px" /> -->
...
?>
    ...
    <!-- <dd class="col-sm-9"><strong>RUFINO M. MIRANDA</strong></dd>   
    <dd class="col-sm-9">Deputy CENRO / EMS II</dd>   -->
</body>
</html>