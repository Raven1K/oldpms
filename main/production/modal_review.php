...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal_1" >Disapprove</button>
...
if ( isset($_POST['Disapprove']) && isset($_POST['Disapprove']) ) {
  ...
  $sql = "UPDATE lumber_app_doc_erow SET date_approved = :date_approved, date_disapprove = :date_disapprove,
  doc_app_ind = :doc_app_ind, doc_status = :doc_status, remarks = :remarks
  WHERE upload_id_doc  = $nshow";
  $stmt = $connection->prepare($sql);
  $stmt->execute(array(
':date_approved' => $dtdis,
...
<form class="form-control" method="post" >
	   ...
	   <div class="col-md-12 ms-auto">
           ...
           <textarea id="remarks" name="remarks"  rows="15" class="form-control"></textarea>
          </div>
