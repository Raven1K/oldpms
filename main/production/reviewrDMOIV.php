...
?>
          ...
          
          {
            ...
            <form method="POST">
              <button class="btn btn-Success" type="submit" value="Recommend" name="Approve_All" style="background-color: #28a745; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">Recommend </button>
          </form>
      </div>
    </div>
  </div>
