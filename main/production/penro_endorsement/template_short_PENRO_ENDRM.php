...
<table>
    ...
    <!-- <td>
        <center><h4 style="white-space: nowrap;" ><strong>Republic of the Philippines<br />
        Department of Environment and Natural Resources<br />
		PROVINCIAL ENVIRONEMENT AND NATURAL RESOURCES<br />
        <?php  $penroaddress; ?> </strong></h4><center>
    </td> -->
    ...
    <center>
        ...
        <?php echo $penroaddress; ?> </strong><center>
    </center>
    </td>

    <td class="title">
                                <img src="bagongpilipinas.png" style="width: 200%; max-width: 200%" />
                                </td>
    </tr>
	</table>
...
// while ( $row = $stmt->fetch(PDO::FETCH_ASSOC) ) {
	...
	<dd class="col-sm-9" style="text-align:justify;">d.) The lumber dealer establishment of <?php echo $bussiness_name ; ?> were verified/inspected by the personnel of <?php echo $municipal_qry_result ; ?> per attached geotagged photographs on <?php echo $datevalidation ?>.</dd>
	<br/>
	...
	<table border=1>
        ...
        <tbody>
           ...
           <tr class="item">
            ...
            <!-- <tr class="item">
                <td style="text-align: center">Service Fee </td>
                <td style="text-align: center"><?php echo $refnumber; ?></td>
            ...
            <tr class="item">
                ...
                <td style="text-align: center"><?php echo $refnumber; ?></td>
                <td style="text-align: center">Php <?php echo $cashbond ?></td>
            </tr>
...
if (($Flow_stat) >= ('12')) {
    ...
    echo '<img src="uploads/'. $signature_1.'" style="width: 600%; max-width: 600px" />';
}
