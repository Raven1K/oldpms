   ...
   // Check if the first part is "00|0000"
    if ($first_part === "00|0000") {
      ...
      function function_alert($message) {
        ...
        // Display the alert box 
        // echo "<script type='text/javascript'>alert('Successfully Rated'); window.location.href=docstatus_released.php?lumber_app_id="$lumber_app_id";</script>";
        echo "<script type='text/javascript'>alert('Already paid successfully'); window.location.href='confirm_payment.php?lumber_app_id=".$lumber_app_id."';</script>";
      }
    ...
    // echo "<script type='text/javascript'>alert('Payment Transaction Pending Please Wait...'); window.location.href='doctracker.php?lumber_app_id=".$lumber_app_id."';</script>";
    echo "<script type='text/javascript'>alert('Payment Transaction Pending Please Wait...'); history.back();</script>";
