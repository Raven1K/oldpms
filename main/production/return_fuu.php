...
$lumber_app = "SELECT * FROM user_role WHERE Rolw_id2 = '" . $_SESSION["user_role_id"] . "'";
...
$Title = $_SESSION['user_role_name'] . ' Returned to CENRO Forest Utilization Unit';
...
Returned to  : CENRO Forest Utilization Unit '. $_SESSION['station'] . '';
