...
$lumber_ap_row2 = mysqli_fetch_assoc($lumber_app_qry1);
 ...
 ?> 
    ...
    <input type="text" name="Payment_Status" placeholder="Payment Status" value="<?php echo $lumber_ap_row["Payment_Status"];?>" readonly>   
        ...
        <div class="col-md-6 col-sm-6  form-group has-feedback">
    <input type="text" name="Payment_Mode" placeholder="Payment Mode">    
        <p> Payment Mode: </p>
        </div>
        <div class="col-md-6 col-sm-6  form-group has-feedback">
...
<form class="form-label-left input_mask" method="post" action="generate-pdf_RED.php" target="_blank" >
...
<div class="form-group row">
  <div class="col-md-9 col-sm-9  offset-md-4">
    <button type="submit" class="btn btn-success" >Generate Endorsement to RED</button>
