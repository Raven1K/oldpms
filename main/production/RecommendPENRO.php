          ...
          
          {
              ...
              $Approved_CG = 'Approved (CG)';
                ...
                echo('<a class="btn btn-warning" href="generates_view_pdf_DMOIV.php?lumber_app_id='.$row['lumber_app_id'].'">View </a>');
                  ...
                  echo ('<a class="btn btn-warning" target="_blank" href="generates_view_pdf.php?lumber_app_id='.$row['lumber_app_id'].'">View</a>');
...
if ( isset($_POST['Approve_All'])) {
 ...
 $Time = date("h:i:sa");
    ...
    $Title = 'PENRO Chief TSD';
    $Details = 'Document reviewed and application recommended to the PENR Officer for endorsement to the Regional Office.';
 ...
 // ------------------------------------------------------------------------------------------------
  ...
  function function_alert($message) {
	...
	echo "<script type='text/javascript'>alert('Successfully Recommended');location='application.php';</script>";
}
...
<form method="POST">
    <input class="btn btn-success" type="submit" value="Recommend to PENRO" name="Approve_All">
</form>
