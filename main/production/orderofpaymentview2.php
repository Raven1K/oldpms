<?php
              ...
              $office_cover = $result2['office_cover'];
                ...
                $Office_1 = $Office . ' - CENRO' || $Office_1 = $Office . ' - HEAD DENR SATELLITE OFFICE'; // Concatenate office type to $Office
  ...
  <div class="container mt-5 border border-dark border-3 p-3 w-50">
    <div class="container mt-1">
      ...
      <div class="row">
        ...
        <div class="text-end col-11 mt-3" ><u><b>____________<?php echo $name_andsig;?>_______________</b></u></div>
        <div class="text-center col-5"></div>
