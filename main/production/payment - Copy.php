    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- <div class="bg-pay p-3"> <span class="font-weight-bold">Online Lumber Dealer Payment Summary</span> -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- <div class="bg-pay p-3"> <span class="font-weight-bold">Online Dealer Application Payment</span> -->
                ...
                <div class="d-flex justify-content-between mt-2"> <span class="fw-500">Cash Bond </span> <span>₱1,000.00</span> </div>
                <hr>
                <div class="d-flex justify-content-between mt-2"> <span class="fw-500">Total </span> <span class="text-success">₱2,216s.00</span> </div>
                <hr>
                <br>
                <br>
