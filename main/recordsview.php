                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
						<div class="row justify-content-center">
							  ...
							  <!-- <li> <form method="POST"><button  class="btn-primary btn-sm btn-round btn ml-0" name="Approve"></form> -->
                <!-- <li><a  data-toggle="modal" data-target="#myModal3" class="btn-primary btn-sm btn-round btn ml-0"> -->
...
// $stmt = $connection->query("SELECT * FROM lumber_app_doc_erow  where lumber_app_id = $l_id ORDER BY doc_type_name");
$stmt = $connection->query("SELECT * FROM lumber_app_doc_erow WHERE lumber_app_id = $l_id AND Number_of_doc BETWEEN 1 AND 13 ORDER BY doc_type_name");
...

{
    ...
    $For_Review_LPDD_CF	 = 'For Review (LPDD) CF';
      ...
      //   echo ('<a class="btn btn-warning" href="production\generates_view_pdf2.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
        ...
        // echo (htmlentities($row['doc_status']));
        echo ("</td><td>");
        echo ('<a class="btn btn-warning" target="_blank" href="production/endorsement_PENRO_modal.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
        ...
        // echo (htmlentities($row['doc_status']));
        echo ("</td><td>");
        // echo ('<a class="btn btn-success" target="_blank" href="generate_VIEW.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');.

        echo ('<a class="btn btn-success" href="modaltemp_RED.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
        ...
        // echo (htmlentities($row['doc_status']));
        echo ("</td><td>");
        echo ('<a class="btn btn-success" target="_blank" href="records/generate_viewLumberEdealer.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
      }

     elseif (($row['doc_status']) == ('Release Certification')) {
        echo (htmlentities('Reviewed'));
        // echo (htmlentities($row['doc_status']));
        echo ("</td><td>");
        echo ('<a class="btn btn-success" target="_blank" href="generate_viewLumberEdealer.php?lumber_app_id=' . $row['lumber_app_id'] . '">View</a>');
      }
