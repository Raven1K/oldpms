                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
										...
										<!-- 	<img class="img-fluid img-thumbnail rounded-circle mx-auto d-block" src="img/gryf.png"> -->
                                            <i class="fas fa-th-list fa-2x text-gray-500"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
										...
										<!--	<img class="img-fluid img-thumbnail rounded-circle mx-auto d-block" src="img/puff.png"> -->
                                            <i class="fas fa-certificate fa-2x text-gray-500"></i> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
										...
										<!--	<img class="img-fluid img-thumbnail rounded-circle mx-auto d-block" src="img/claw.png"> -->
                                            <i class="fas fa-calendar-alt fa-2x text-gray-500"></i> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-bottom-warning shadow h-80 py-2 ">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
        								 <a  class= "nav-link" href="tables.php"> <i>  
			 								<div class="text-s font-weight-bold text-warning text-uppercase mb-1">
			 										Pending Reviews</div> </i>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800"># of Reviews</div> 
										</a>
                                        </div>
                                        <div class="col-auto">
										<!--	<img class="img-fluid img-thumbnail rounded-circle mx-auto d-block" src="img/slyt.png"> -->
