...
// where Flow_stat = $l_id
          ...
          while ( $row = $stmt->fetch(PDO::FETCH_ASSOC) ) {
            ...
            echo '<div class="modal fade" id="evaluationModal' . htmlspecialchars($row['lumber_app_id']) . '" tabindex="-1" role="dialog" aria-labelledby="evaluationModalLabel' . htmlspecialchars($row['lumber_app_id']) . '" aria-hidden="true">
        ...
        $For_review_R_RO_FUS = 'For review R-RO FUS';
                ...
                // echo(htmlentities($row['uniqid_lapp']));
                echo("</td><td>");
                ...
                //  echo(htmlentities('LD-R13-'.''.$row['Suffix'].'-'.$dateyear.'00___________'));
                ...
                if (($row['Application_status']) == ("Return_FUU")){
