	  ...
	  <!-- Chart Monthly Summary -->
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Lumber Dealer Registrations <small>| Spatial Summary</small></h2>
<!--
                    <div class="filter">
...
-->
                  ...
                  <div class="x_content">
                    <div class="col-md-10 col-sm-12 ">
                      <div class="demo-container" style="height:550px">
                        <div class="demo-placeholder">
							<section id="indexmap">										
										<div class="mapouter">
											<div class="gmap_canvas">
												<iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/d/embed?mid=1jkr2Kxow5vb8Gw_CuUnOobeYS2r3sfk&hl=en&ehbc=2E312F">
												</iframe>
											</div>
												<style>.mapouter{position:relative;text-align:right;width:100%;height:600px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:600px;}.gmap_iframe {height:750px!important;}
												</style>
												<br>
										</div>
							</section>
...
-->
                    ...
                    <div class="col-md-2 col-sm-12 ">
                      <div>
						...
						<ul class="messages">
                          <li>
							  <span class="text-info"><strong>Total Lumber Dealer</strong></span></br>
                          <h3>200</h3></br>
                          <span class="sparkline11 graph" style="height: 160px;">
                               <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                          </span></br></br>
...
-->
                          ...
                          <li>
							  <span class="text-info"><strong>Total Approved</strong></span></br>
                          <h3>150</h3></br>
                          <span class="sparkline22 graph" style="height: 160px;">
                                <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                          </span></br></br>
...
-->
                          ...
                          <li>
							  <span class="text-warning"><strong>Lumber Dealer to Expire</strong></span></br>
                          <h3>20</h3></br></br>
                          <span class="sparkline11 graph" style="height: 160px;">
                                 <canvas width="200" height="60" style="display: inline-block; vertical-align: top; width: 94px; height: 30px;"></canvas>
                          </span>
	  ...
	  <!-- Chart CENRO Summary -->
			...
			<div class="row">
					  <div class="col-md-12">
						<div class="x_panel">
						  <div class="x_title">
							<h2>Infographics Summary <small>Activity shares</small></h2>							
							<div class="clearfix"></div>
						  </div>
						  <div class="x_content">
							...
							<div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
							    ...
							    <div class="col-md-8">
									 <div class="x_panel">
									  <div class="x_title">
										<h2>Lumber Dealer Summary | <small>Monthly</small></h2>										
										<div class="clearfix"></div>
									  </div>
										 <?php
											require_once('columnchart.php');
