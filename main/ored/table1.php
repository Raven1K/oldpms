          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="text-success"><strong>Reports</strong><small>  | Existing Lumber Dealers within Caraga Region</small></h3>
              </div>              
            </div>
            ...
            <div class="row">
			  <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Office of the RED <small>| Regional Office Users</small></h2>
