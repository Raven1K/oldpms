          ...
          <div class="">
            ...
            <div class="row">
			  <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><strong>Office of the Regional Executive Director</strong> <small>| Regional Office Users</small></h2>
								...
								<table id="datatable-responsive"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                         <tr>
                                            ...
                                            <td>
												<span class="text-primary"><i class="bi bi-upload me-1 text-primary"></i><strong>Release</strong></span>
                                         ...
                                         <tr>
                                            ...
                                            <td >
												<span class="text-success"><i class="bi bi-upload me-1 text-info"></i><strong> For Release </strong></span>
											</td>                               
                                         </tr>
                                         <tr>
											<td>5</td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
												<span class="text-primary"><i class="bi bi-upload me-1 text-primary"></i><strong>For Release</strong></span>
