          ...
          <div class="card" style="width: 600px; height: 650px;">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <div >
                      ...
                      <input disabled type="text" class="form-control" placeholder="Jobert" id="fnames" required>
                    </div>
                    <div style="margin-top: 10px;" >
                      <label for="validationDefault01" class="form-label" style="font-weight: 500; font-size: 14px; margin-bottom: -2px; color: #444444;">Last name</label>
                      <input disabled type="text" class="form-control" placeholder="Awa" id="lastnames" required>
                    </div>
            ...
            <!-- aboutme -->
                  ...
                  <div class="row mb-3"  style="font-weight: 500; font-size: 14px; width: 540px; margin-left: 5px; color: #444444">
                    ...
                    <div class="col-sm-10">
                      <input disabled type="email" class="form-control" id="emails" placeholder="jawa999">
                    </div>
                  </div>
