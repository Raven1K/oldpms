      ...
      <div class="form-step form-step-active">
        <div class="input-group">
         ...
         <div class="row">
          ...
          <input  style="width: 330px;" type="text" class="form-control" placeholder="First Name*" aria-label="First name"  name="perm_fname" >
          </div>
          <div class="col"><br>
          <input  style="width: 330px;" type="text" class="form-control" placeholder="Last Name*" aria-label="Last name"  name="perm_lname" >
          </div>
        </div>
         <div class="row">
          <div class="col">
