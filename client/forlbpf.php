...
if ($stmt) {
  ...
  $merchantcode = "1344"; // Assigned Merchant Code for DENR CARAGA: 1512
  $bankcode = "B000"; // LBP = B000 (Fixed)
  
  // Define the characters to remove
  $remove_chars = array(",", "'", "&");
  
  // Sanitize the parameters by removing unwanted characters
  $trxndetails = str_replace($remove_chars, "", $payment_transaction); // Transaction Type
  $trandetail1 = str_replace($remove_chars, "", $Serial_No); // Merchant Reference Number
  $trandetail2 = str_replace($remove_chars, "", $Name_of_Payor); // Name_of_client/Payorname
  $trandetail3 = str_replace($remove_chars, "", $_GET['email']); // Email address
  $trandetail4 = str_replace($remove_chars, "", $Address_Office_of_Payor); // Business Address
  $trandetail5 = str_replace($remove_chars, "", $bussiness_name); // Lumber Dealer Trade Name
  $trandetail6 = str_replace($remove_chars, "", $FundCluster); // DENR FUND CLUSTER
  $trandetail7 = str_replace($remove_chars, "", $code); // Responsibility Center
  $trandetail8 = null;
  $trandetail9 = null;
  $trandetail10 = null;
  $trandetail11 = 0;
...
<body>
  ...
  <label>Please Confirm the Amount and Email Address</label>
      </br>
    <label for="amount">Amount: <?php echo $trxnamt; ?></label>
    <input type="text" id="amount" name="trxnamt" value="<?php echo $trxnamt; ?>" hidden>
    ...
    <input type="text" id="merchant_code" name="merchantcode" value="<?php echo $merchantcode; ?>" hidden>
    
    <!-- <label for="bank_code">Bank Code:</label> -->
    <input type="text" id="bank_code"  value="<?php echo $bankcode; ?>" name="bankcode" hidden>
    
    <!-- <label for="transaction_type">Transaction Type:</label> -->
    <input type="text" id="transaction_type"  name="trxndetails"  value="<?php echo $trxndetails; ?>" hidden>
    
    <!-- <label for="merchant_ref_number">Merchant Reference Number:</label> -->
    <input type="text" id="merchant_ref_number"  name="trandetail1" value="<?php echo $trandetail1; ?>" hidden>
    
    <!-- <label for="client_name">Name of Client/Payor Name:</label> -->
    <input type="text" id="client_name" name="trandetail2" value="<?php echo $trandetail2; ?>" hidden>
    
    <label for="email">Email address:</label>
    <input type="email" id="email" name="trandetail3" value="<?php echo $trandetail3; ?>" required readonly>
   
    <!-- <label for="Business_address">Address Business/Address:</label> -->
    <input type="text" id="Business_address" name="trandetail4" value="<?php echo $trandetail4; ?>" hidden>

    <!-- <label for="lumber_dealer_name">Lumber Dealer Trade Name:</label> -->
    <input type="text" id="lumber_dealer_name" name="trandetail5" value="<?php echo $trandetail5; ?>" hidden>

    <!-- <label for="denr_fund_cluster">DENR FUND CLUSTER:</label> -->
    <input type="text" id="denr_fund_cluster" name="trandetail6" value="<?php echo $trandetail6; ?>" hidden>
    
    <!-- <label for="responsibility_center">Responsibility Center:</label> -->
    <input type="text" id="responsibility_center" name="trandetail7" value="<?php echo $trandetail7; ?>" hidden>

    <!-- <label for="trandetail8">Detail 8:</label> -->
    <input type="text" id="trandetail8" name="trandetail8" value="<?php echo $trandetail8; ?>" hidden>
    
    <!-- <label for="trandetail9">Detail 9:</label> -->
    <input type="text" id="trandetail9" name="trandetail9" value="<?php echo $trandetail9; ?>" hidden>
    
    <!-- <label for="trandetail10">Detail 10:</label> -->
    <input type="text" id="trandetail10" name="trandetail10" value="<?php echo $trandetail10; ?>" hidden>

    <!-- <label for="trandetail11">Detail 11:</label> -->
    <input type="text" id="trandetail11" name="trandetail11" value="<?php echo $trandetail11; ?>" hidden>

    <!-- <label for="trandetail12">Detail 12:</label> -->
    <input type="text" id="trandetail12" name="trandetail12" value="<?php echo $trandetail12; ?>" hidden>

    <!-- <label for="trandetail13">Detail 13:</label> -->
    <input type="text" id="trandetail13" name="trandetail13" value="<?php echo $trandetail13; ?>" hidden>

    <!-- <label for="trandetail14">Detail 14:</label> -->
    <input type="text" id="trandetail14" name="trandetail14" value="<?php echo $trandetail14; ?>" hidden>

    <!-- <label for="trandetail15">Detail 15:</label> -->
    <input type="text" id="trandetail15" name="trandetail15" value="<?php echo $trandetail15; ?>" hidden>

    <!-- <label for="trandetail16">Detail 16:</label> -->
    <input type="text" id="trandetail16" name="trandetail16" value="<?php echo $trandetail16; ?>" hidden>

    <!-- <label for="trandetail17">Detail 17:</label> -->
    <input type="text" id="trandetail17" name="trandetail17" value="<?php echo $trandetail17; ?>" hidden>

    <!-- <label for="trandetail18">Detail 18:</label> -->
    <input type="text" id="trandetail18" name="trandetail18" value="<?php echo $trandetail18; ?>" hidden>

    <!-- <label for="trandetail19">Detail 19:</label> -->
    <input type="text" id="trandetail19" name="trandetail19" value="<?php echo $trandetail19; ?>" hidden>

    <!-- <label for="trandetail20">Detail 20:</label> -->
    <input type="text" id="trandetail20" name="trandetail20" value="<?php echo $trandetail20; ?>" hidden>

    
    <!-- <label for="callbackurl">Callback URL:</label> -->
    <input type="text" id="callbackurl" name="callbackurl" value="https://o-ldpms.denr.gov.ph/client/callbackurl.php" hidden>
    ...
    <input type="text" id="password" name="password" value="password" hidden>
...
?>
    ...
    <form action="echo.php" method="get" hidden>
       <h2>Perform Echo</h2>
...
<form method="post" hidden>
  ...
  <?php 
        ...
        if ($Payment_Status == 'Paid') {
          ...
          echo '<form method="POST" class="form-container" hidden>';
