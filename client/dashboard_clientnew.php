...
<div id='bodybox'>
        ...
        <div class="input-group">
         ...
         <div class="row">
          <div class="col">
            ...
            <select class="form-select" id="autoSizingSelect" style="margin-top: 10px; width: 330px;" name="permit_type" required>
  ...
  <tr>
      ...
      <td align="center">
          <button type="button" id="custom-button6" class="btn btn-primary btn-sm" style="width: 100px; height:30px;"name="my_image6" disabled>Browse..</button>
          <input type="file" id="realfile6" hidden="hidden" name="my_image6" accept="application/pdf" value=""/>
          <div class="form-check form-switch">
              <br>
              <input type="checkbox" class="form-check-input" id="switch6" onchange="toggleButton6()" style="width: 3em; height: 1.5em;">
              <label class="form-check-label" for="switch6">(Switch the toggle if Renewal Applicant)</label>
          </div>         
          
          <script>
            function toggleButton6() {
              var switchBtn = document.getElementById('switch6');
              var button = document.getElementById('custom-button6');
              button.disabled = !switchBtn.checked;
            }
          </script>   
    </td>
  ...
  <tr>
      <td style="border-right-color: #fff;">
      <span id="custom-text7" style="font-size: 13px; color: #808080;">6.5 Proof of ownership of the lumberyard or consent/agreement with the owner<span style="font-weight: 500; color: red;"><i> *Required</i></span></span>
      </td>
      <td align="center">
      ...
      <td align="center" style="color: #808080; font-size: 15px;"id="mb7"></td>
        ...
        <div class="btns-group">
          ...
          <button type="submit" class="btn btn-success" name="btn" data-toggle="modal" data-target="#submittingModal" disabled="true" id="acceptBtn">Submit</button>

          <!-- Modal -->
          <div class="modal fade" id="submittingModal" tabindex="-1" role="dialog" aria-labelledby="submittingModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-body text-center">
                  ...
                  <p class="mt-2">Submitting your files...</p>
                </div>
              </div>
            </div>
          </div>
  ...
  realFileBtn7.addEventListener("change", function(){
      ...
      var totalBytes7 = this.files[0].size;
        for (var i = 0; i < this.files.length; i++){
         customTxt7.style.color="red";
            customTxt7.innerHTML = "<span style = 'color:black'>" + "6.5 Proof of ownership of the lumberyard or consent/agreement with the owner <br>" + "</span>" +  this.files.item(i).name;
    ...
    customTxtMB7.style.color = "#808080";
        if (realFileBtn7.value) {
          ...
          customTxt7.innerHTML = "6.5 Proof of ownership of the lumberyard or consent/agreement with the owner ";
