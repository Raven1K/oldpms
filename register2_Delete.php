...
// include 'processphp/univmodal.php';
...
<div class="custom-card text-center" style=" border-color: #ecedf0;">
  <div class="custom-card-header" style="background-color: #ecedf0; cursor: pointer; border-color: #2987ce; border-width: thick;">
    <ul class="nav nav-tabs custom-card-header-tabs" style="border-color:#ecedf0;">
        <li class="nav-item">
          <a class="nav-link " style="cursor: pointer;"  href="index.php" ><img src="images/oldpmslogoreg.png"></a>
        </li>
...
<!-- for  multilingual file back end reciptional  -->
                              ...
                              <input autocomplete="off" style="margin-bottom: 5px;" type="password" class="form-control user_password" placeholder="Password*" aria-label="pw" name="password">
                              
                              <input autocomplete="off" style="margin-bottom: 5px;" type="password" class="form-control user_confirm_password" placeholder="Confirm Password*" aria-label="confirm_pw" name="Cpassword">
                              ...
                              <input class="form-control formFileMultiple1" type="file" accept="Application/pdf" id="formFileMultiple" name="my_image1" multiple>
                              </div>
  

                               <div class="mb-3">
                              <i><label style="font-size: 12px; float: left;">Upload Company's Authorization Letter*</label></i>
                              <input class="form-control formFileMultiple3" type="file" accept="Application/pdf" id="formFileMultiple"  name="my_image3" multiple>
                              </div></div></p>
                              <center>
