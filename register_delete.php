...
<!-- for  multilingual file back end reciptional  -->
                              ...
                              <input style="margin-bottom: 5px;" type="text" class="form-control user_email" placeholder="E-Mail*" aria-label="email" name="email">
                          <form class="row g-3" style="margin-bottom: 10px;">
                              <div class="col-auto" style="width: 50%;">
                              <input type="text" style="font-size:15px;" class="form-control user_mobileno" placeholder="Mobile No.*" name="mobilenum"></div>
                              <div class="col-auto">
                              <button type="submit" class="btn btn-danger verify_yournoBtn"><span style="font-size: 10px;">Verify Your No.</span></button></div>
                        
                              <input style="margin-bottom: 5px;" type="text" class="form-control user_password" placeholder="Password*" aria-label="pw" name="password"></div>
                    <div class="col">
                              ...
                              <input style="margin-bottom: 5px;" type="text" class="form-control user_confirm_email" placeholder="Confirm E-Mail*" aria-label="confirm_email" name="Cemail">
                              <input style="margin-bottom: 10px;" type="text" class="form-control user_verifycode" placeholder="Verification Code*" aria-label="verification_code" name="vcode">
                              <input style="margin-bottom: 5px;" type="text" class="form-control user_confirm_password" placeholder="Confirm Password*" aria-label="confirm_pw" name="Cpassword"></div></div>
                              <br>
                              <div class="mb-3">
                              ...
                              <input class="form-control formFileMultiple3" type="file" id="formFileMultiple" multiple name="my_image3">
                              </div></div></p>
                              <center>
  ...
  <div class="modal-dialog" style="margin-top: 7%;">
    <div class="modal-content" >
      ...
      <div class="modal-footer">
              ...
              <!-- <button class="btn  btn-success" name="btn"> Log In </button> -->
      </div>
        </form>
    </div>
  </div>
