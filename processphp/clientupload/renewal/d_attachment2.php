<?php
            ...
            $name_app_doc1 = 'Lumber Supply Contract/Agreement from legitimate suppliers/subsisting lumber dealers.';
            ...
            $query->bindParam("name_app_doc", $new_img_name2, PDO::PARAM_STR);
