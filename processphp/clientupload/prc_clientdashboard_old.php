...
// not functional insertion post in another provided 
                    ...
                    echo  $idkeylumber = $result['lumber_app_id'];
                        ...
                        // echo "<script type='text/javascript'>alert('successfully Submitted');location='../../client/Oldfile_Renewal.php?lumber_app_id=".$idkeylumber."';</script>";
                        // echo "<script type='text/javascript'>alert('Successfully submitted'); location='../../client/Oldfile_Renewal.php?lumber_app_id=" . urlencode($idkeylumber) . "';</script>";
